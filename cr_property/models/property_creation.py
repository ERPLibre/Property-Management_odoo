...
#=======================================================
    ...
    image = fields.Binary()
    property_image_ids = fields.One2many('property.image', 'property_creation_id')
...
class PropertyProperty(models.Model):
    ...
    def button_rent_contract(self):
        return {
            ...
            'type': 'ir.actions.act_window',
            'domain': [('property_id', '=', self.id),('property_creation_id','=',self.property_creation_id.id)],
        }

    # def compute_count_rent_contract(self):
    #     for contract in self:
    #         contract.contract_count = self.env["tenancy.details"].search_count(
    #             [('tenant_id.property_creation_id.id', '=', self.id)])
