    ...
    def create_rent_record(self):
        ...
        if self.start_date and self.expiration_date and self.tenancy_rent:
            ...
            for i in lst_of_date:
                # print("====================i==============",i)
                vals = {'tenant_id':self.tenant_id.tenant_id.name,'property_id':self.tenant_id.property_id.id,'property_creation_id':self.tenant_id.property_creation_id.id,'date': i, 'amount': self.tenancy_rent,'tenancy_detail_id':self.id,'pending_amount':self.tenancy_rent}
                print("===============vals=======================",vals)
